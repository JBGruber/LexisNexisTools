...
[![Coverage Status](https://codecov.io/gh/JBGruber/LexisNexisTools/branch/master/graph/badge.svg)](https://codecov.io/github/JBGruber/LexisNexisTools?branch=master)
...
This package provides functions to read in TXT files downloaded from 'LexisNexis' and comes with a few other features I think come in handy while working with data from the popular newspaper archive.
...
use (**note: the Github version is recommended at the moment as it has several new useful features while old code has massively improved**):
...
unlink(c("./vignettes/SampleFile_20091201-20100511_1-10.txt",
