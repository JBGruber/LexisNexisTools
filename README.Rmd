...
**Note: the GitHub Version now supports .docx files from Nexis Uni (see [this issue](https://github.com/JBGruber/LexisNexisTools/issues/7#issuecomment-509000414))**
